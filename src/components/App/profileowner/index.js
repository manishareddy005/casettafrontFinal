    ...
    constructor(props){
       ...
       this.state = {
        ...
        componentDidMount(){
            ...
            const urlo = "http://localhost:9000/users/me";
            ...
            fetch(urlo,{
              ...
              headers:{
               ...
               'Access-Control-Allow-Origin': urlo
              }
            })
           ...
           .then((responseJson)=>{console.log("username:" + this.state.userdata.username)
           this.setState({
               ownerbody:this.state.userdata.username
           })
                    

           console.log("username in Profileowner:"+this.state.ownerbody)
           ...
           console.log("ownername:"+ JSON.stringify(this.state.ownerbody))
           let bodyo="{\"username\":"+JSON.stringify(this.state.ownerbody)+"}"
